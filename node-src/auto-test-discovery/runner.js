...
function findTests(
    ...
    return new Promise(function(resolve, reject) {
        function finish() {
            console.log("Executing "+readElmiPath+ " --path"+ " "+elmPackageJsonPath);
            ...
            process.on("close", function(code) {
                console.log("Completed "+readElmiPath);
                if (stderrStr !== "") {
                    console.log("Error: "+stderrStr);
                    reject(stderrStr);
                } else if (code !== 0) {
                ...
                var filteredModules = _.chain(modules)
                    .map(function(mod) {
                        let eligible = _.chain(mod.types)
                            .map(function(typ) {
